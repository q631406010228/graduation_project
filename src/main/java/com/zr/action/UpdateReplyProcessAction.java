...
/**
 * Servlet implementation class UpdateReplyProcess
 */
@WebServlet("/UpdateReplyProcess")
public class UpdateReplyProcessAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
	ReplyProcessService rpservice = new ReplyProcessServiceImpl();      
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateReplyProcessAction() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int i = rpservice.updateReplyProcess(sid, ques, answer);
